...
# Todos los cuerpos con efemérides propias, planetas y asteroides juntos.
TRANSITABLE_BODIES = {**PLANETS, **ADDITIONAL_BODIES}
...
def calculate_transit_calendar(natal_planets, jd_start, jd_end):
    ...
    for transit_p in TRANSIT_PLANETS:
        planet_id = TRANSITABLE_BODIES[transit_p]
...
def calculate_chart(birth: BirthData, lang: str = IDIOMA_POR_DEFECTO):
    try:
        ...
        for tp in TRANSIT_PLANETS:
            data = calc_planet(jd_now, TRANSITABLE_BODIES[tp])
